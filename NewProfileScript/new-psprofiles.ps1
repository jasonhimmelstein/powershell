...
$version = "v5.06 updated on 11/17/2017"
#  Jason Himmelstein
#  http://www.sharepointlonghorn.com
#  @jasehimm

#Display the profile version
Write-host "$filename $version" -BackgroundColor Black -ForegroundColor Green
...
Write-Host "Setting the Remote Execution policy to allow Registry changes" -BackgroundColor Black -ForegroundColor Yellow 
Set-ExecutionPolicy RemoteSigned -Scope CurrentUser -Force
#endregion

#region creating blank files & folders
# This will create a logs and scripts directory off of the C:\ Root
Write-Host "Creating the logs and scripts directories..." -BackgroundColor Black -ForegroundColor Yellow
...
Write-Host "Creating the file to check for existing profiles or create new ones..." -BackgroundColor Black -ForegroundColor Yellow
New-Item -type file -Path $scriptspath\$checkforprofiles

# Create the file that will be used to create PowerShell profiles 
Write-Host "Creating the creating profiles script file..." -BackgroundColor Black -ForegroundColor Yellow
...
Write-Host "Creating script to create profiles..." -BackgroundColor Black -ForegroundColor Yellow
...
Write-Host "Creating batch file to run check-profiles..." -BackgroundColor Black -ForegroundColor Yellow
New-item -type file -path $scriptspath\$checkprofileshortcut -force
#endregion

#region check-profiles.ps1
Write-Host "Adding content to the check for profiles script file..." -BackgroundColor Black -ForegroundColor Yellow
...
Write-Host "Adding content to the creating profiles script file..." -BackgroundColor Black -ForegroundColor Yellow
Add-Content $scriptspath\$createprofile {
#PowerShell Profiles to be used
$filename = "Microsoft.PowerShell_profile.ps1"
$version = "v5.01 updated on 11/17/2017"
#Jason Himmelstein
#http://www.sharepointlonghorn.com
...
Add-Content $psprofile { 
        ...
        #PowerShell Profiles to be used
        $filename = "Microsoft.PowerShell_profile.ps1"
        $version = "v4.24 updated on 11/17/2017"
        #Jason Himmelstein
        #http://www.sharepointlonghorn.com
        #@jasehimm
...
Write-Host "Adding content to the create PowerShell Profiles batch file..." -BackgroundColor Black -ForegroundColor Yellow
...
Write-Host "Adding content to the batch file to launch the check for profiles script file..." -BackgroundColor Black -ForegroundColor Yellow
...
Write-Host "Adding a link to favorites in Windows Explorer to the PowerShellScripts folder..." -BackgroundColor Black -ForegroundColor Yellow
